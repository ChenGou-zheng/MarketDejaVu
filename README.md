...
| 纯 MTM 过滤后 | 10 | 10 个 rqdata MTM(无ETF) | 3 | -11.49% | -0.048 | 53.1% | 96.62% | +9.76% | 61.3% |
| **纯 MTM 不过滤** | **37** | **全部 37 个 MTM** | **3** | **∞%** | **∞** | **91.4%** | 91.99% | **∞%** | **90.3%** |
| **v4.0 最终** | **63** | **39 映射+13 ETF+11 MTM** | **3** | **+23.66%** | **0.311** | 50.4% | 31.43% | **+6.77%** | **54.8%** |

> 纯 MTM 不过滤时年化超额 ∞%, 因 26 个含 MTM 噪声的策略支配了 KNN 选择。证明质量过滤的必要性。
