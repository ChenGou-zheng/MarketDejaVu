...
| **v4.0 全池** | **62** | 39 映射+13 ETF+**10 rqdata MTM** | **3** | **+23.66%** | **0.311** | 50.4% | 31.43% | **+6.77%** | **54.8%** |

**推荐: v4.0 全池 K=3** — OOS 年化 +6.77%, OOS 块胜率 54.8%, 回撤 31.43%。62 策略全池融合了 ETF 覆盖度、行业映射多样性和 rqdata MTM 的真实交易回报。
